...
df = sql_query('''SELECT * FROM applications LIMIT 10''')
...
plt.pie(ab_counts.first_name.values, labels=['A', 'B'], autopct='%0.5f%%')
plt.axis('equal')
plt.show()
...
plt.show()
plt.savefig('percent_users_apply.png')
...
ax.set_yticklabels(['0%', '5%', '10%', '15%', '20%'])
plt.show()
plt.savefig('percent_users_purchase.png')
